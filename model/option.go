...
func InitOptionMap() {
	...
	common.OptionMap["AffCommissionPercentage"] = strconv.Itoa(common.AffCommissionPercentage)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AffCommissionPercentage":
		common.AffCommissionPercentage, _ = strconv.Atoi(value)
